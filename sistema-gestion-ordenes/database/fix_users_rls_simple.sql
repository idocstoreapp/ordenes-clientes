...
-- Política 1: CUALQUIERA puede ver encargados (incluye sucursales con auth.uid() = NULL)
-- Esta es la política más importante para que las sucursales funcionen
CREATE POLICY "users_select_encargados_anyone" ON users FOR SELECT
...
-- 5. Verificar que funciona (debería mostrar todos los encargados)
SELECT 
  '=== PRUEBA: Encargados disponibles ===' as seccion;
